...
def Trim(t, p=0.01):
    ...
    """
    n = int(p * len(t))
    print('length of t: {0}, p: {1}, n: {2}'.format(len(t), p, n))
    t = sorted(t)[n:-n]
    return t
...
def TrimmedMean(t, p=0.01):
    ...
    Args:
        t: sequence of numbers
        p: traction of values to trim off each end
...
def Binom(n, k, d={}):
    ...
    Args:
        ...
        d: map from (n, k) tuples to cached result
...
def main():
    ...
    # Mean Test
    print('Mean Test')
    print('Mean: {0}'.format(Mean(list1)))
    print('Var: {0}'.format(Var(list1)))
    # Trim Test
    print('Trim Test')
    print(Trim([3, 4, 5, 1, 2]))
    print(Trim([3, 4, 5, 1, 2], 0.2))
    print(Trim([3, 4, 5, 1, 2], 0.4))
